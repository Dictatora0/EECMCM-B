...
def load_q2_stations(
    ...
    records = [
        StationRecord(
            ...
            assigned_overflow_load=float(row.get("assigned_overflow_load", 0.0) or 0.0),
...
def load_q2_allocations(
    ...
    records = [
        AllocationRecord(
            ...
            overflow_station=normalize_optional_station_name(row.get("overflow_station", "")),
            ...
            overflow_load_daily=float(row.get("overflow_load_daily", 0.0) or 0.0),
